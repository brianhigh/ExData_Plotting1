# plot4.R - Household Power Consumption 4-plot Plot
...
par(mfcol = c(2, 2))
plot(twodaydf$datetime, twodaydf$Global_active_power, xlab="", sub="", 
...
legend("topright", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), 
       lty=c(1,1), col=c("black", "blue","red"), bty = "n")
plot(twodaydf$datetime, twodaydf$Voltage, type = "l", 
     ylab="Voltage", xlab = "datetime")
plot(twodaydf$datetime, twodaydf$Global_reactive_power, type = "l", 
